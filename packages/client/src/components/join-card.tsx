...
const JoinCard: React.FC = () => {
	...
	const handleRoomCreation = (e: React.FormEvent) => {
		...
		if (displayName.length > 48) {
			toast.error("Username cannot be longer than 48 characters.");
			return;
		}
	...
	return (
		<div className="w-full sm:w-[75%] lg:w-[50%] p-4 flex flex-col items-center gap-8 max-w-[700px] m-auto rounded-lg shadow-md shadow-black/20 min-h-[10rem] dark:border">
			<ProfileSlider setImage={setImage} />
