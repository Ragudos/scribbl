		...
		return (
			<React.Fragment>
				<div className="flex items-center gap-2">
					...
					<select
						onChange={changeAmountOfPlayers}
						value={maxAmountOfPlayers}
						className="py-1 px-2 rounded-lg bg-background border focus-visible:ring-2 focus-visible:ring-accent/20 focus-visible:ring-offset-background focus-visible:ring-offset-2"
					>
